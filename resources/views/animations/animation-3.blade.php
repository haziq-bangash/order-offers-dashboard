...
<body >
    <div id="animation">
        ...
        <!-- card -->
            ...
            <div class="card">
                <div class="card-body text-center text-dark fw-bold display-4">
                    <h1 id="yayText" class="display-1 text-warning fw-bold">Yay!</h1>
            ...
            {{-- avatars --}}
            <div id="avatars" >
                <img src="assets/img/boy_avatar.png" alt="" id="boy" >
                <img src="assets/img/girl_avatar.png" alt="" id="girl" >
            </div>
    </div>
